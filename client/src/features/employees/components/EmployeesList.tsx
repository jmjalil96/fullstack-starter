...
import type { EmployeeListItemResponse } from '../employees'
...
const COLUMNS: Column<EmployeeListItemResponse>[] = [
  {
    key: 'name',
    header: 'Nombre',
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-4 md:p-6">
      ...
      <DataTable
        ...
        onRowClick={(employee) => navigate(`/admin/empleados/${employee.id}`)}
        emptyMessage="No se encontraron empleados con estos filtros."
      />
    </div>
  )
}
